...
export function BrandMark() {
  return <span className="brand-mark" aria-label={`${profile.name} home`}><span className="brand-icon" aria-hidden="true"><Icon name="code" size={17} /><span /></span><span className="brand-mark__initials">{profile.initials}</span></span>;
}
