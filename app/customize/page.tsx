...
import { getProfile, isProfileEditor } from "../data/profile-server";
...
function CustomizeGate() {
  return <main className="customize-page"><div className="container customize-shell customize-message"><span className="section-index">PRIVATE EDITOR</span><h1>Sign in to customize your portfolio</h1><p>This page is only for the site owner. Sign in with ChatGPT to continue.</p><a className="button button--primary" href={chatGPTSignInPath("/customize")}>Sign in with ChatGPT</a><Link className="text-link" href="/">Back to public site</Link></div></main>;
}

function CustomizeAccessDenied() {
  return <main className="customize-page"><div className="container customize-shell customize-message"><span className="section-index">PRIVATE EDITOR</span><h1>This account cannot edit the site</h1><p>Sign out and use the ChatGPT account that owns this portfolio.</p><a className="button button--secondary" href="/signout-with-chatgpt?return_to=/customize">Sign out</a><Link className="text-link" href="/">Back to public site</Link></div></main>;
}
